...
class ParkingTest extends TestCase
{
     ...
     * in three methods: for starting the parking, for getting the correct price after X hours, and for stopping the parking.
     */
     ...
     public function testUserCanStopParking()
     {
         ...
         $this->travel(2)->hours();  // allows us to simulate that the current time is actually 2 hours ahead,
